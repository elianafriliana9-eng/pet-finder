...
define(['./workbox-53feb3a3'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "index.html",
    "revision": "0.qou71ou63g4"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/^https:\/\/[a-c]\.basemaps\.cartocdn\.com\/.*|^https:\/\/[a-c]\.tile\.openstreetmap\.org\/.*/i, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/\/api\/(reports|shelters|ads).*/i, new workbox.NetworkFirst({
